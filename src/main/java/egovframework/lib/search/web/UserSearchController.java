package egovframework.lib.search.web;
...
import egovframework.lib.search.service.*;
...
public class UserSearchController{
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/lib/detail.do")
    public String detail(ModelMap model, HttpServletRequest request, HttpSession session) throws Exception {
		...
		// 도서관 리스트
		SearchVO svo = SearchService.SelectDetail(uid);
